...
export TERRAFORM_PROVIDER_VERSION ?= v0.67.1
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-exoscale
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/exoscale/terraform-provider-exoscale/releases/download//$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-exoscale_0.67.1
...
xpkg.build.provider-exoscale: do.build.images
