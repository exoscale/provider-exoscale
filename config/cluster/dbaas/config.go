...
func Configure(p *config.Provider) {
	...
	p.AddResourceConfigurator("exoscale_dbaas_mysql_database", func(r *config.Resource) {
		r.ShortGroup = shortGroup
		r.Kind = "DBAASDatabaseMySQL"
	...
	p.AddResourceConfigurator("exoscale_dbaas_kafka_user", func(r *config.Resource) {
		r.ShortGroup = shortGroup
		r.Kind = "DBAASUserKafka"
	...
	p.AddResourceConfigurator("exoscale_dbaas_opensearch_user", func(r *config.Resource) {
		r.ShortGroup = shortGroup
		r.Kind = "DBAASUserOpenSearch"
