...
var ExternalNameConfigs = map[string]config.ExternalName{
	...
	"exoscale_iam_org_policy": config.IdentifierFromProvider, // only works with terraform-provider-exoscale version > 0.68.x TODO: upgrade terraform version in makefile once the new release is out.
}
