...
type InstanceInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/exoscale/provider-exoscale/apis/cluster/compute/v1alpha1.BlockStorageVolume
	// +listType=set
	...
	// +kubebuilder:validation:Optional
	BlockStorageVolumeIdsRefs []v1.Reference `json:"blockStorageVolumeIdsRefs,omitempty" tf:"-"`

	// Selector for a list of BlockStorageVolume in compute to populate blockStorageVolumeIds.
	// +kubebuilder:validation:Optional
	BlockStorageVolumeIdsSelector *v1.Selector `json:"blockStorageVolumeIdsSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/exoscale/provider-exoscale/apis/cluster/compute/v1alpha1.ElasticIP
	// +listType=set
	...
	// +kubebuilder:validation:Optional
	ElasticIPIdsRefs []v1.Reference `json:"elasticIpIdsRefs,omitempty" tf:"-"`

	// Selector for a list of ElasticIP in compute to populate elasticIpIds.
	// +kubebuilder:validation:Optional
	ElasticIPIdsSelector *v1.Selector `json:"elasticIpIdsSelector,omitempty" tf:"-"`
	...
	// +crossplane:generate:reference:type=github.com/exoscale/provider-exoscale/apis/cluster/compute/v1alpha1.SSHKey
	// +listType=set
