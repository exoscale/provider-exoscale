...
type InstancePoolInitParameters struct {
	...
	AffinityGroupIdsRefs []v1.Reference `json:"affinityGroupIdsRefs,omitempty" tf:"-"`

	// Selector for a list of AntiAffinityGroup in compute to populate affinityGroupIds.
	// +kubebuilder:validation:Optional
	AffinityGroupIdsSelector *v1.Selector `json:"affinityGroupIdsSelector,omitempty" tf:"-"`
