...
func (mg *BlockStorageVolume) GetTerraformResourceType() string {
	return "exoscale_block_storage_volume"
}
...
// GetInitParameters of this BlockStorageVolume
func (tr *BlockStorageVolume) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this BlockStorageVolume
func (tr *BlockStorageVolume) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
